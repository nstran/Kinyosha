...
@Component({
  selector: 'app-lead-template-quick-gift',
  templateUrl: './lead-template-quick-gift.component.html',
  styleUrls: ['./lead-template-quick-gift.component.css']
})
export class LeadTemplateQuickGiftComponent implements OnInit {
  ...
  sendGift() {
    if (!this.formQuickGift.valid) {
      ...
      this.awaitResult = true;
        this.leadCareService.sendGiftSupportLead(this.titleControl.value.trim(), giftCustomerType1, giftTypeId1, giftTotal1,
