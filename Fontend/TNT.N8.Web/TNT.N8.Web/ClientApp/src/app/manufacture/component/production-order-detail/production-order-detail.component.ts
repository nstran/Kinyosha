...
export class ProductionOrderDetailComponent implements OnInit {
  ...
  initTable() {
    this.colsFinishedProduct = [
      ...
      { field: 'productCode', header: 'Mã sản phẩm', textAlign: 'center', display: 'table-cell', width: '15%' },
      { field: 'productName', header: 'Tên sản phẩm', textAlign: 'center', display: 'table-cell', width: '20%' },
      { field: 'lotNoName', header: 'LOT.NO', textAlign: 'center', display: 'table-cell', width: '10%' },
      { field: 'productionNumber', header: 'Số lượng sản phẩm', textAlign: 'center', display: 'table-cell', width: '10%' },
      { field: 'startDate', header: 'Ngày bắt đầu', textAlign: 'center', display: 'table-cell', width: '15%' },
      { field: 'statusName', header: 'Trạng thái', textAlign: 'center', display: 'table-cell', width: '15%' },
      { field: 'setting', header: 'Thao tác', textAlign: 'center', display: 'table-cell', width: '10%' },
    ];

    this.colsNVLProduct = [
      { field: 'stt', header: 'STT', width: '10%' },
      { field: 'productCode', header: 'Mã NVL', textAlign: 'center', display: 'table-cell', width: '30%' },
      { field: 'productName', header: 'Tên NVL', textAlign: 'center', display: 'table-cell', width: '30%' },
      { field: 'productUnitName', header: 'Đơn vị tính', textAlign: 'center', display: 'table-cell', width: '30%' },
    ];
  }
  ...
  onRowSelect(event) {
    this.customer = event.data.customerName;
  }
}
