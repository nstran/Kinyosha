...
export class CategoryService {
  ...
  createCategory(categoryName: string, categoryCode: string, categoryTypeId: string, categoryOrder: number, categoryTypeCode: string, description: string) {
    ...
    return this.httpClient.post(url, {
      ...
      SortOrder: categoryOrder, CategoryTypeCode: categoryTypeCode, Description: description
    }).pipe(
      map((response: Response) => {
        return response;
      }));
  ...
  editCategoryById(categoryId: string, categoryName: string, categoryCode: string, categoryOrder: number, description: string) {
