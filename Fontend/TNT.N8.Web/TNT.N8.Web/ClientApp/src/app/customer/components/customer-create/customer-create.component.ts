...
export class CustomerCreateComponent implements OnInit {
  ...
  isInvalidFormAgent: boolean = false;
  ...
  initForm() {
    let KHDN_PhoneControl = new FormControl("", [Validators.required, Validators.pattern(this.getPhonePattern())]);
    let KHDN_Contact_PhoneControl = new FormControl("", [Validators.required, Validators.pattern(this.getPhonePattern()), checkDuplicateCode(this.listPhoneContactCode)]);
    let KHCN_Phone = new FormControl('', [Validators.required, Validators.pattern(this.getPhonePattern())]);

    if (this.applicationName == 'VNS') {
      KHDN_PhoneControl = new FormControl("", [Validators.pattern(this.getPhonePattern())]);
      KHDN_Contact_PhoneControl = new FormControl("", [Validators.pattern(this.getPhonePattern()), checkDuplicateCode(this.listPhoneContactCode)]);
      KHCN_Phone = new FormControl('', [Validators.pattern(this.getPhonePattern())]);
      //Đại lý
    ...
    this.contactCustomerForm = new FormGroup({
      ...
      "Phone": KHDN_Contact_PhoneControl,
  ...
  toggleNotifiErrorAgent() {
    this.isOpenNotifiErrorAgent = !this.isOpenNotifiErrorAgent;
  }
                ...
                if (resultBank.statusCode === 202 || resultBank.statusCode === 200) {
                  switch (type) {
                    ...
                    case "save_new":
                      ...
                      this.showToast('success', 'Thông báo', 'Tạo khách hàng thành công');
                      this.resetAllForm();
                      this.isInvalidForm = false;
                  ...
                  this.showToast('error', 'Thông báo', resultBank.messageCode);
                }
  ...
  mappingAgentCustomerContacFormToModel(): ContactModel {
    ...
    contactModel.ProvinceId = this.agentCustomerForm.get('provinceControl').value ? this.agentCustomerForm.get('provinceControl').value.provinceId : null;
    contactModel.DistrictId = this.agentCustomerForm.get('districtControl').value ? this.agentCustomerForm.get('districtControl').value.districtId : null;
    contactModel.WardId = this.agentCustomerForm.get('wardControl').value ?  this.agentCustomerForm.get('wardControl').value.wardId : null;
  ...
  mappingCompanyCustomerContacFormToModel(): ContactModel {
    ...
    contactModel.ProvinceId = this.companyCustomerForm.get('provinceControl').value? this.companyCustomerForm.get('provinceControl').value.provinceId : null;
    contactModel.DistrictId = this.companyCustomerForm.get('districtControl').value? this.companyCustomerForm.get('districtControl').value.districtId : null;
    contactModel.WardId = this.companyCustomerForm.get('wardControl').value? this.companyCustomerForm.get('districtControl').value.wardId : null;
          ...
          switch (type) {
            case "Email":
              ...
              if (resultCheckEmail.statusCode === 200) {
                ...
                this.showToast('error', 'Thông báo', resultCheckEmail.messageCode);
              }
              break;
            case "EmailOther":
              ...
              if (resultCheckEmailOther.statusCode === 200) {
                ...
                this.showToast('error', 'Thông báo', resultCheckEmailOther.messageCode);
              }
              break;
            case "EmailWork":
              ...
              if (resultCheckEmailWork.statusCode === 200) {
                ...
                this.showToast('error', 'Thông báo', resultCheckEmailWork.messageCode);
              }
              break;
            default:
              break;
          ...
          switch (type) {
            case "Phone":
              ...
              if (resultCheckPhone.statusCode === 200) {
                ...
                this.showToast('error', 'Thông báo', resultCheckPhone.messageCode);
              }
              break;
            case "PhoneOther":
              ...
              if (resultCheckPhoneOther.statusCode === 200) {
                ...
                this.showToast('error', 'Thông báo', resultCheckPhoneOther.messageCode);
              }
              break;
            case "PhoneWork":
              ...
              if (resultCheckPhoneWork.statusCode === 200) {
                ...
                this.showToast('error', 'Thông báo', resultCheckPhoneWork.messageCode);
              }
              break;
            default:
              break;
    ...
    switch (Number(this.customerType)) {
      ...
      case 3:
        if (this.applicationName == 'VNS') {
          ...
          this.agentCustomerForm.get('PersonalEmail').setValue(leadContactModel.email);
          this.agentCustomerForm.get('PersonalPhone').setValue(leadContactModel.phone);
        }
      default:
        break;
    }
  ...
  changeMKH() {
    //Nếu ứng dụng không phải dùng cho VNS
    if (this.isCustomerCodeLikeTaxCode && this.applicationName != 'VNS') {
  ...
  isInlandOnChange() {
    if (Number(this.isInland) == 1) {
      ...
      this.agentCustomerForm.get('provinceControl').setValidators([Validators.required]);
      this.agentCustomerForm.get('provinceControl').updateValueAndValidity();
      this.agentCustomerForm.get('districtControl').setValidators([Validators.required]);
      this.agentCustomerForm.get('districtControl').updateValueAndValidity();
      this.agentCustomerForm.get('wardControl').setValidators([Validators.required]);
      this.agentCustomerForm.get('wardControl').updateValueAndValidity();
    }
    else {
      ...
      this.agentCustomerForm.get('provinceControl').clearValidators();
      this.agentCustomerForm.get('provinceControl').updateValueAndValidity();
      this.agentCustomerForm.get('districtControl').clearValidators();
      this.agentCustomerForm.get('districtControl').updateValueAndValidity();
      this.agentCustomerForm.get('wardControl').clearValidators();
      this.agentCustomerForm.get('wardControl').updateValueAndValidity();
    }
