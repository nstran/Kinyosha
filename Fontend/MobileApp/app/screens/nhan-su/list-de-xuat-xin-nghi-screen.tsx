  ...
  const ItemView = ({ item, index }) => {
    return (
      <TouchableOpacity style={[styles.card,
        item?.statusName == "Nháp" ? { borderColor: "rgb(174, 164, 160)" } :
          item?.statusName == "Đã phê duyệt" ? { borderColor: "rgb(0, 122, 255)" } :
            item?.statusName == "Đang chờ phê duyệt" ? { borderColor: "rgb(255, 204, 0)" } : {},
