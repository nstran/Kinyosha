...
namespace TN.TNM.Api.Controllers
{
    public class WareHouseController : Controller
    {
        ...
        [HttpPost]
        [Route("api/warehouse/getListWareHouse")]
        [Authorize(Policy = "Member")]
        public GetListWareHouseResult GetListWareHouse([FromBody] GetListWareHouseParameter request)
        {
            return iWareHouseDataAccess.GetListWareHouse(request);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/warehouse/changeStatusInventoryReceivingVoucherTP")]
        [Authorize(Policy = "Member")]
        public ChangeStatusInventoryReceivingVoucherResult ChangeStatusInventoryReceivingVoucherTP([FromBody] ChangeStatusInventoryReceivingVoucherParameter request)
        {
            return iWareHouseDataAccess.ChangeStatusInventoryReceivingVoucherTP(request);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/warehouse/changeStatusInventoryReceivingVoucherProduction")]
        [Authorize(Policy = "Member")]
        public ChangeStatusInventoryReceivingVoucherResult ChangeStatusInventoryReceivingVoucherProduction([FromBody] ChangeStatusInventoryReceivingVoucherParameter request)
        {
            return iWareHouseDataAccess.ChangeStatusInventoryReceivingVoucherProduction(request);
        }
        /// <summary>
        ...
        [Authorize(Policy = "Member")]
        public CreateUpdateInventoryDeliveryVoucherResult CreateUpdateInventoryDeliveryVoucher([FromBody]CreateUpdateInventoryDeliveryVoucherParameter request)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/warehouse/createUpdateInventoryDeliveryVoucherRequest")]
        [Authorize(Policy = "Member")]
        public CreateUpdateInventoryDeliveryVoucherResult CreateUpdateInventoryDeliveryVoucherRequest([FromBody]CreateUpdateInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.CreateUpdateInventoryDeliveryVoucherRequest(request);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/warehouse/changeStatusInventoryDeliveryVoucherRequest")]
        [Authorize(Policy = "Member")]
        public ChangeStatusInventoryDeliveryVoucherResult ChangeStatusInventoryDeliveryVoucherRequestRequest([FromBody] ChangeStatusInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.ChangeStatusInventoryDeliveryVoucherRequest(request);
        }
        /// <summary>
        /// ChangeStatusInventoryDeliveryVoucher
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        [Route("api/warehouse/changeStatusCancelInventoryDeliveryVoucherRequest")]
        [Authorize(Policy = "Member")]
        public ChangeStatusInventoryDeliveryVoucherResult ChangeStatusCancelInventoryDeliveryVoucherRequest([FromBody] ChangeStatusInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.ChangeStatusCancelInventoryDeliveryVoucherRequest(request);
        }
        /// <summary>
        ...
        //
        [HttpPost]
        [Route("api/warehouse/getInventoryInfo")]
        [Authorize(Policy = "Member")]
        public GetInventoryInfoResult GetInventoryInfo([FromBody] GetInventoryInfoParameter request)
        {
            return iWareHouseDataAccess.GetInventoryInfo(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getInventoryInfoSX")]
        [Authorize(Policy = "Member")]
        public GetInventoryInfoResult GetInventoryInfoSX([FromBody] GetInventoryInfoParameter request)
        {
            return iWareHouseDataAccess.GetInventoryInfoSX(request);
        }

        [HttpPost]
        [Route("api/warehouse/getInventoryInfoTP")]
        [Authorize(Policy = "Member")]
        public GetInventoryInfoTPResult GetInventoryInfoTP([FromBody] GetInventoryInfoTPParameter request)
        {
            return iWareHouseDataAccess.GetInventoryInfoTP(request);
        }

        [HttpPost]
        [Route("api/warehouse/getChiTietBaoCaoTP")]
        [Authorize(Policy = "Member")]
        public GetInventoryInfoTPResult GetChiTietBaoCaoTP([FromBody] GetInventoryInfoTPParameter request)
        {
            return iWareHouseDataAccess.GetChiTietBaoCaoTP(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getMasterInventoryDeliveryVoucher")]
        [Authorize(Policy = "Member")]
        public GetMasterInventoryDeliveryVoucherResult GetMasterInventoryDeliveryVoucher([FromBody] GetMasterInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.GetMasterInventoryDeliveryVoucher(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/createPhieuNhapKhoNVLCCDC")]
        [Authorize(Policy = "Member")]
        public CreatePhieuNhapKhoResult CreatePhieuNhapKhoNVLCCDC([FromBody] CreatePhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.CreatePhieuNhapKhoNVLCCDC(request);
        }
        [HttpPost]
        [Route("api/warehouse/createPhieuNhapKhoTP")]
        [Authorize(Policy = "Member")]
        public CreatePhieuNhapKhoResult CreatePhieuNhapKhoTP([FromBody] CreatePhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.CreatePhieuNhapKhoTP(request);
        }
        //
        //[HttpPost]
        //[Route("api/warehouse/createPhieuNhapKhoCCDC")]
        //[Authorize(Policy = "Member")]
        //public CreatePhieuNhapKhoResult CreatePhieuNhapKhoCCDC([FromBody] CreatePhieuNhapKhoParameter request)
        //{
        //    return iWareHouseDataAccess.CreatePhieuNhapKhoCCDC(request);
        //}
        //
        //[HttpPost]
        //[Route("api/warehouse/searchListPhieuNhapKhoCCDC")]
        //[Authorize(Policy = "Member")]
        //public SearchListPhieuNhapKhoResult SearchListPhieuNhapKhoCCDC([FromBody] SearchListPhieuNhapKhoParameter request)
        //{
        //    return iWareHouseDataAccess.SearchListPhieuNhapKhoCCDC(request);
        //}
        //
        [HttpPost]
        [Route("api/warehouse/searchListPhieuNhapKhoNVLCCDC")]
        [Authorize(Policy = "Member")]
        public SearchListPhieuNhapKhoResult SearchListPhieuNhapKhoNVLCCDC([FromBody] SearchListPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.SearchListPhieuNhapKhoNVLCCDC(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/searchListPhieuNhapKhoSX")]
        [Authorize(Policy = "Member")]
        public SearchListPhieuNhapKhoResult SearchListPhieuNhapKhoSX([FromBody] SearchListPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.SearchListPhieuNhapKhoSX(request);
        }
        //
        //[HttpPost]
        //[Route("api/warehouse/searchListPhieuNhapKhoTSD")]
        //[Authorize(Policy = "Member")]
        //public SearchListPhieuNhapKhoResult SearchListPhieuNhapKhoTSD([FromBody] SearchListPhieuNhapKhoParameter request)
        //{
        //    return iWareHouseDataAccess.SearchListPhieuNhapKhoTSD(request);
        //}
        //
        [HttpPost]
        [Route("api/warehouse/searchListPhieuNhapKhoTP")]
        [Authorize(Policy = "Member")]
        public SearchListPhieuNhapKhoResult SearchListPhieuNhapKhoTP([FromBody] SearchListPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.SearchListPhieuNhapKhoTP(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getMasterCreatePhieuNhapKhoNVLCCDC")]
        [Authorize(Policy = "Member")]
        public GetMasterDataPhieuNhapKhoResult GetMasterCreatePhieuNhapKhoNVLCCDC([FromBody] GetMasterDataPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.GetMasterCreatePhieuNhapKhoNVLCCDC(request);
        }
        //
        //[HttpPost]
        //[Route("api/warehouse/getMasterCreatePhieuNhapKhoCCDC")]
        //[Authorize(Policy = "Member")]
        //public GetMasterDataPhieuNhapKhoResult GetMasterCreatePhieuNhapKhoCCDC([FromBody] GetMasterDataPhieuNhapKhoParameter request)
        //{
        //    return iWareHouseDataAccess.GetMasterCreatePhieuNhapKhoCCDC(request);
        //}
        ////
        //[HttpPost]
        //[Route("api/warehouse/getDetailPhieuNhapKhoCCDC")]
        //[Authorize(Policy = "Member")]
        //public GetDetailPhieuNhapKhoResult GetDetailPhieuNhapKhoCCDC([FromBody] GetDetailPhieuNhapKhoParameter request)
        //{
        //    return iWareHouseDataAccess.GetDetailPhieuNhapKhoCCDC(request);
        //}
        //
        [HttpPost]
        [Route("api/warehouse/getDetailPhieuNhapKhoNVLCCDC")]
        [Authorize(Policy = "Member")]
        public GetDetailPhieuNhapKhoResult GetDetailPhieuNhapKhoNVLCCDC([FromBody] GetDetailPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.GetDetailPhieuNhapKhoNVLCCDC(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getDetailPhieuNhapKhoSX")]
        [Authorize(Policy = "Member")]
        public GetDetailPhieuNhapKhoResult GetDetailPhieuNhapKhoSX([FromBody] GetDetailPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.GetDetailPhieuNhapKhoSX(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getDetailPhieuNhapKhoTSD")]
        [Authorize(Policy = "Member")]
        public GetDetailPhieuNhapKhoResult GetDetailPhieuNhapKhoTSD([FromBody] GetDetailPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.GetDetailPhieuNhapKhoTSD(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getDetailPhieuNhapKhoTP")]
        [Authorize(Policy = "Member")]
        public GetDetailPhieuNhapKhoResult GetDetailPhieuNhapKhoTP([FromBody] GetDetailPhieuNhapKhoParameter request)
        {
            return iWareHouseDataAccess.GetDetailPhieuNhapKhoTP(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/searchInventoryDeliveryVoucherRequest")]
        [Authorize(Policy = "Member")]
        public SearchInventoryDeliveryVoucherResult SearchInventoryDeliveryVoucherRequest([FromBody] SearchInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.SearchInventoryDeliveryVoucherRequest(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/searchInventoryDeliveryVoucherNVLCCDC")]
        [Authorize(Policy = "Member")]
        public SearchInventoryDeliveryVoucherResult SearchInventoryDeliveryVoucherNVLCCDC([FromBody] SearchInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.SearchInventoryDeliveryVoucherNVLCCDC(request);
        }
        //
        [HttpPost]
        [Route("api/warehouse/getEmployeeByOrganizationId")]
        [Authorize(Policy = "Member")]
        ...
        {
            return iWareHouseDataAccess.GetEmployeeByOrganizationId(request);
        }
        [HttpPost]
        [Route("api/warehouse/searchInventoryDeliveryVoucherSX")]
        [Authorize(Policy = "Member")]
        public SearchInventoryDeliveryVoucherResult SearchInventoryDeliveryVoucherSX([FromBody] SearchInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.SearchInventoryDeliveryVoucherSX(request);
        }

        [HttpPost]
        [Route("api/warehouse/searchInventoryDeliveryVoucherTP")]
        [Authorize(Policy = "Member")]
        public SearchInventoryDeliveryVoucherResult SearchInventoryDeliveryVoucherTP([FromBody] SearchInventoryDeliveryVoucherParameter request)
        {
            return iWareHouseDataAccess.SearchInventoryDeliveryVoucherTP(request);
        }
        [HttpPost]
        [Route("api/warehouse/getInventoryStockByWarehouse")]
        [Authorize(Policy = "Member")]
        public GetInventoryStockByWarehouseResult GetInventoryStockByWarehouse([FromBody] GetInventoryStockByWarehouseParameter request)
        {
            return iWareHouseDataAccess.GetInventoryStockByWarehouse(request);
        }
    }
}
