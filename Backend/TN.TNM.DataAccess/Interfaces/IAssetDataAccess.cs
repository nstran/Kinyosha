...
namespace TN.TNM.DataAccess.Interfaces
{
    public interface IAssetDataAccess
    {
        ...
        SearchWareHouseResult SearchListWareHouse(SearchWareHouseParameter parameter);
        UpdateDotKiemKeDetailResult UpdateDotKiemKeDetail(UpdateDotKiemKeDetailParameter parameter);

        ChangeTrangThaiDotKiemKeResult ChangeTrangThaiDotKiemKe(ChangeTrangThaiDotKiemKeParameter parameter);
        CanBangDotKiemKeDetailResult CanBangDotKiemKeDetail(CanBangDotKiemKeDetailParameter parameter);

        TaoPhieuXuatCanBangKhoResult TaoPhieuXuatCanBangKho(TaoPhieuXuatCanBangKhoParameter parameter);
        TaoPhieuNhapCanBangKhoResult TaoPhieuNhapCanBangKho(TaoPhieuNhapCanBangKhoParameter parameter);
    }
}
