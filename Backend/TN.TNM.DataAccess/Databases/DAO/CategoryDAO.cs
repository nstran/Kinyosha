    ...
    public class CategoryDAO : BaseDAO, ICategoryDataAccess
    {
        ...
        public CreateCategoryResult CreateCategory(CreateCategoryParameter parameter)
        {
            try
            {
                ...
                if (parameter.CategoryTypeId == Guid.Empty && string.IsNullOrEmpty(parameter.CategoryTypeCode))
                {
                ...
                else
                {
                    ...
                    if (parameter.CategoryTypeId != Guid.Empty && parameter.CategoryTypeId != null)
                     categoryType =
                        context.CategoryType.FirstOrDefault(ct => ct.CategoryTypeId == parameter.CategoryTypeId);
                    else
                        categoryType =
                            context.CategoryType.FirstOrDefault(ct => ct.CategoryTypeCode == parameter.CategoryTypeCode);
                    ...
                    else
                    {
                        ...
                        var lstAll = GetAllCategory(new GetAllCategoryParameter());

                        return new CreateCategoryResult()
                        {
                            CategoryId = category.CategoryId,
                            CategoryTypeList = lstAll?.CategoryTypeList,
                            StatusCode = HttpStatusCode.OK,
        ...
        public EditCategoryByIdResult EditCategoryById(EditCategoryByIdParameter parameter)
        {
            try
            {
                ...
                else
                {
                    ...
                    category.Description = parameter.Description;
